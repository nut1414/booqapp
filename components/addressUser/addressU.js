export function AddressU({ name, addressDetail, onclick, noDelete, className }) {
    ...
    return (
        <div className={`${className}`}>
            <div>    
                ...
                { !noDelete && <button className = {"text-xl font-light  text-spooky-orange underline  transition-all float-right mr-32"}onClick={onclick}>Delete</button>}
