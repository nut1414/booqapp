export function Button({ onClick, text, type, className, onSubmit }) {
  const typeClass = type === "secondary" ? "text-spooky-orange bg-white hover:text-white hover:bg-spooky-orange " : "bg-spooky-orange text-white hover:text-spooky-orange hover:bg-white "
