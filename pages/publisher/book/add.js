...
export default function PublisherBookAdd() {
  return (
    <Template>
      ...
      sideChildren={<div><img className=" w-80" src="/addbook.svg"></img>
      <p className="text-white mt-5 text-xs text-opacity-60 font-semibold inline-flex">jpg, jpeg, png (max file size 5MB)</p>
      <Button className="ml-11 mt-8" text={"upload"} type={"secondary"}></Button></div>}
       children={<div className=" ml-48 mt-10">
