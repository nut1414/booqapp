  ...
  return (
    <Template>
      ...
      <div className="float-right mt-6">
       ...
       <div>
       <div className="grid grid-cols-4 ml-48 mt-6 ">
       ...
       <div> <div className="border-b border-black border-opacity-30 mt-3 ml-48 mr-48"></div></div>
      </div>
      <div>
      ...
      <div><Button text={"+Add"} className={"float-right mr-[12rem] mt-8"} onClick={""}></Button></div>
    </Template>
  )
}